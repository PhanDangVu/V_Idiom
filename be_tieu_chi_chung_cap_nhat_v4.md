# Bể Tiêu Chí Chung & Định Nghĩa Song Ngữ (Bản Cập Nhật v4)

Bản cập nhật **v4** nâng cấp toàn bộ hệ thống phân loại thành ngữ - tục ngữ Việt - Anh với hai cải tiến chính:

1. **Bổ sung Định nghĩa Tiếng Anh (`Giải_thích_nghĩa_Tiếng_Anh`):** Cung cấp giải nghĩa chi tiết bằng tiếng Anh bên cạnh nghĩa tiếng Việt cho từng cặp thành ngữ để phục vụ bài toán căn chỉnh ngữ nghĩa đa ngôn ngữ (Cross-Lingual Alignment / Semantic Gloss) chuẩn mực.
2. **Cấu trúc 100 dòng định dạng cặp (1 dòng = 1 cặp thành ngữ Việt - Anh):** Mỗi dòng tích hợp song song cặp thành ngữ Tiếng Việt và Tiếng Anh cùng hai cột giải nghĩa song ngữ (`Giải_thích_nghĩa_Tiếng_Việt` & `Giải_thích_nghĩa_Tiếng_Anh`) và bộ tiêu chí ngữ nghĩa (`BC_`, `HD_`, `KQ_`, `MD_`).
...
### 1. Bối Cảnh (Contexts) - Ký hiệu: `BC_` (21 tiêu chí)
...
### 2. Hành Động (Actions) - Ký hiệu: `HD_` (19 tiêu chí)
...
### 3. Kết Quả (Results) - Ký hiệu: `KQ_` (30 tiêu chí)
...
### 4. Mục Đích (Purposes) - Ký hiệu: `MD_` (9 tiêu chí)
